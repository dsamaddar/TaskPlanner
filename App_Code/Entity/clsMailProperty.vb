...
Public Class clsMailProperty
    Dim _MailPropertyID, _MailTypeID, _MailSubject, _MailBody, _MailFrom, _MailTo, _MailCC, _MailBCC, _EntryBy, _MailHeader, _MailFooter, _SMTPServer, _Attachment As String
