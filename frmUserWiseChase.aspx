<%@ Page Language="VB" MasterPageFile="~/ChaserMaster.master" AutoEventWireup="false"
    Theme="CommonSkin" CodeFile="frmUserWiseChase.aspx.vb" Inherits="frmUserWiseChase"
                ...
                <div id="modal_dialog" style="display: none">
                    <table width="100%">
                        ...
                        <tr align="center">
                            ...
                            ControlToValidate="drpEmployeeList"  ErrorMessage="please Select a Person to Forwar the chase" Text="*"  CssClass="error"  Operator="NotEqual" 
                            ValidationGroup="UpdateChase" ValueToCompare="0" />
                                        </td>
                                    </tr>
                                    <tr align="left">
                                        <td class="label" style="width: 150px">
                                    ...
                                    <tr align="left">
                                        ...
                                        <td>
                                            ...
                                            &nbsp;<asp:Button ID="btnTerminateChase" runat="server" Text="Terminate Chase" ValidationGroup="UpdateChase1"
                                                OnClientClick="if (!confirm('Are you Sure to Terminate the Chase ?')) return false" />
                                                 <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True"
        ShowSummary="False" ValidationGroup="UpdateChase" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
