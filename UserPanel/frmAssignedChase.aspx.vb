...
Partial Class UserPanel_frmAssignedChase
    ...
    'Protected Sub GetAllAssignedByChases(ByVal InitiatorID As String)
    '    grdChaserReportDetails.DataSource = GenChaseData.fnGetAssignedChase(InitiatorID)
