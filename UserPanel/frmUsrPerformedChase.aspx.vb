...
Partial Class frmUsrPerformedChase
    Inherits System.Web.UI.Page

    Dim GenChaseData As New clsGeneratedChaseDataAccess()
    Dim ChaseNoteData As New clsChaseNotesDataAccess()

    Protected Sub btnPerformedChase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPerformedChase.Click
        Try
