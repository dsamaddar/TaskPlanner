<%@ Page Language="VB" MasterPageFile="~/UserPanel/ChaserUserPanel.master" AutoEventWireup="false"
    Theme="CommonSkin" CodeFile="frmChngPrimarySupport.aspx.vb" Inherits="UserPanel_frmChngPrimarySupport"
                ...
                <asp:Panel ID="pnlPrimarySuppRep" runat="server" Width="600px" SkinID="pnlInner">
                    <table style="width: 100%;">
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <asp:DropDownList ID="drpRepresentatives" runat="server" Width="200px" Enabled="False">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr align="left">
