...
Partial Class frmUserWiseChase
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If InStr(MenuIDs, "UsrWiseChase~") = 0 Then
    ...
    Protected Sub grdAssignedChase_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles grdAssignedChase.SelectedIndexChanged
        ...
        Try
            ...
            Session("GeneratedChaseID") = lblMasterChaseID.Text
            ...
            GetContactDetails(lblGeneratedChaseID.Text)
            GetPriorityInfo(lblGeneratedChaseID.Text)
    ...
    Protected Sub ShowUsersListByChaseDef(ByVal ChaseDefinitionID As String)
        ...
        clsGeneratedChaseDataAccess.fnGetChaseInitiatorByGenChaseID(Session("GeneratedChaseID"), InitiatorID, InitiatorName)

        Dim FlagPrimarySup As Integer
        FlagPrimarySup = 0
        For Each item As ListItem In drpEmployeeList.Items
            If item.Value = InitiatorID Then
                FlagPrimarySup = 1
                Exit For
            End If
        Next

        If FlagPrimarySup = 0 Then
            Dim Initiator As New ListItem
            Initiator.Text = InitiatorName
            Initiator.Value = InitiatorID

            drpEmployeeList.Items.Insert(drpEmployeeList.Items.Count, Initiator)
    ...
    Protected Sub SendMail(ByVal MailProp As clsMailProperty)
        ...
        Try
            ...
            If MailProp.Attachment <> "" Then
                Dim at As Attachment = New Attachment(ConfigurationManager.AppSettings("InputChaserFile") + MailProp.Attachment)
