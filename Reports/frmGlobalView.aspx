<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/ChaserMaster.master"
    AutoEventWireup="false" CodeFile="frmGlobalView.aspx.vb" Inherits="Reports_frmGlobalView"
    Title=".:Chaser:Global View:." %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyPlaceHolder" runat="Server">
    ...
    <table style="width: 100%;">
        <tr align="center">
                                ...
                                <asp:GridView ID="grdGlobalView" runat="server" AutoGenerateColumns="False" CssClass="mGrid">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Pending">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkbtnPending" runat="server" CausesValidation="False" 
                                                    CssClass="linkbtn" Font-Size="14px" 
                                                    OnClientClick='<%# Eval("AssignedToID","openWindow(""frmUserWiseChaseAndSts.aspx?EmployeeID={0}&ChaseStatus=Pending"",""Popup"",1000,1100);") %>' 
                                                    Text='<%# Bind("Pending") %>'>
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Forwarded" Visible="false" >
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkbtnForwarded" runat="server" CausesValidation="False" 
                                                    CssClass="linkbtn" Font-Size="14px" 
                                                    OnClientClick='<%# Eval("AssignedToID","openWindow(""frmUserWiseChaseAndSts.aspx?EmployeeID={0}&ChaseStatus=Forwarded"",""Popup"",1000,1100);") %>' 
                                                    Text='<%# Bind("Forwarded") %>'>
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Done">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkbtnTerminated" runat="server" CausesValidation="False" 
                                                    CssClass="linkbtn" Font-Size="14px" 
                                                    OnClientClick='<%# Eval("AssignedToID","openWindow(""frmUserWiseChaseAndSts.aspx?EmployeeID={0}&ChaseStatus=Terminated"",""Popup"",1000,1100);") %>' 
                                                    Text='<%# Bind("Done") %>'>
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
            ...
            <td valign="top" style="width: 400px">
                <asp:Panel ID="pnlGraphicalView" runat="server" SkinID="pnlInner" Width="450px">
                    <table>
                        <tr>
                            <td colspan="3">
                                <div class="widget-title">
    ...
    <tr align="center">
        ...
        <td>
                <asp:Chart ID="crtChaserByUser" runat="server" BackColor="" BorderlineColor="Transparent"
                    Height="300px" Width="400px">
                    <Titles>
                        <asp:Title Name="Items" ShadowOffset="3" />
                    </Titles>
