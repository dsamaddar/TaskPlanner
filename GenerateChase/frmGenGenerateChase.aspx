<%@ Page Language="VB" Theme="CommonSkin" MasterPageFile="~/ChaserMaster.master"
    AutoEventWireup="false" CodeFile="frmGenGenerateChase.aspx.vb" Inherits="GenerateChase_frmGenGenerateChase"
    Title=".:Chaser:Gen. Chase Generation:." %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="headerPlaceHolder" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function CacheItems() {
            ...
            ddl = document.getElementById("<%=drpRequestFor.ClientID %>");
                ...
                <asp:Panel ID="pnlContactPerson" runat="server" SkinID="pnlInner" Width="80%">
                    <table style="width: 100%;">
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <asp:LinkButton ID="lnkBtnVeiwContactDetails" runat="server">Contact Details</asp:LinkButton>
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
