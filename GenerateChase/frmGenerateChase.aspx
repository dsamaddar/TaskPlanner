<%@ Page Language="VB" MasterPageFile="~/ChaserMaster.master" AutoEventWireup="false"
    Theme="CommonSkin" CodeFile="frmGenerateChase.aspx.vb" Inherits="GenerateChase_frmGenerateChase"
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <asp:DropDownList ID="drpChaseList" runat="server" AutoPostBack="True" 
                                    Width="200px" CssClass="InputTxtBox">
                                </asp:DropDownList>
                            </td>
                            <td>
                            </td>
                ...
                <asp:Panel ID="pnlContactPerson" runat="server" SkinID="pnlInner" Width="80%">
                    <table style="width: 100%;">
                        ...
                        <tr align="left">
                            ...
                            <td style="width: 200px">
                                <asp:DropDownList ID="drpULCBranchList" runat="server" AutoPostBack="True" 
                                    Width="200px" CssClass="InputTxtBox">
                                </asp:DropDownList>
                            </td>
                            ...
                            <td>
                                <asp:DropDownList ID="drpRequestFor" runat="server" Width="200px" 
                ...
                <asp:Panel ID="pnlGenerateChase" runat="server" Width="80%" BorderStyle="None" SkinID="pnlInner">
                    <table style="width: 100%;">
                        ...
                        <tr align="left">
                            ...
                            <td>
                                <asp:DropDownList ID="drpPriority" runat="server" Width="200px" 
                                    CssClass="InputTxtBox">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr align="left">
                            ...
                            <td>
                                <asp:DropDownList ID="drpIntRepList" runat="server" Width="200px" 
                                    CssClass="InputTxtBox">
                                </asp:DropDownList>
                            </td>
                            <td>
